...
//we will bring in the openzepplin ERC721 NFT functionality
...
contract NFT is ERC721URIStorage {
    ...
    //counters allow us to keep track of the tokenIds
    ...
    constructor(address marketplaceAddress) ERC721('KryptoBirdz', 'KBIRDSZ') {
    ...
    function mintToken(string memory tokenURI) public returns(uint) {
        ...
        // mint the token and set it for sale - return th id to do so
        return newItemId;
    }
}